    ...
    <section id="nosotros" className="py-16 px-6 bg-[#2C1A1D] text-white">
      <div className="container mx-auto">
        ...
        <p className="text-center mb-12 max-w-2xl mx-auto">
          Descubre la pasión que nos impulsa a seleccionar los mejores vinos para ti.
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <div className="wood-bg p-6 rounded-lg shadow-lg">
              <div className="fondo-madera-interna p-8 rounded">
                <svg className="w-full h-auto" viewBox="0 0 400 300" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <text x="200" y="150" fontFamily="'Playfair Display', serif" fontSize="24" textAnchor="middle" fill="#2C1A1D">
                    Viñedos Haal
                  </text>
                </svg>
              </div>
          ...
          <div>
            ...
            <p className="mb-4">
              Fundada en 1985, Haal nació de la pasión de una familia por los vinos de calidad. Nuestro compromiso con la
              excelencia nos ha llevado a seleccionar cuidadosamente cada botella que ofrecemos.
            </p>
            <p className="mb-6">
              Trabajamos directamente con pequeños productores y bodegas reconocidas para garantizar que cada vino en nuestra
              colección represente lo mejor de su región y variedad.
            </p>
