...
return (
    ...
    <div className="flex justify-center space-x-4 text-xl">
        <a href="#"><i className="fab fa-facebook-f hover:text-[#D4AF37]"></i></a>
        <a href="#"><i className="fab fa-instagram hover:text-[#D4AF37]"></i></a>
        <a href="#"><i className="fab fa-twitter hover:text-[#D4AF37]"></i></a>
    </div>
